...
class Matchup(models.Model):
    ...
    def matchupLeader(self):
        if(self.p1Votes > self.p2Votes):
            return self.player1.__unicode__() + " wins by " + str(self.p1Votes-self.p2Votes) + " votes against " + self.player2.__unicode__()
        elif(self.p2Votes > self.p1Votes):
            return self.player2.__unicode__() + " wins by " + str(self.p2Votes-self.p1Votes) + " votes against " + self.player1.__unicode__()
        else:
            return "Tie between " + self.player1.__unicode__() + " and " + self.player2.__unicode__()
